...
export const REACT_PROJECTS = [
  { id:"r-8", name:"Theme Changer", about:"React theme switcher app with custom color modes, smooth transitions, and persistent user preferences.", link:"https://themechanger-nu.vercel.app", tags:["React","UI"], type:"Web App", year:"2025", color:"#60a5fa", repo:"React-repo" },
  { id:"r-10", name:"Currency Converter", about:"Currency converter built in React with instant exchange rate lookup and a clean responsive interface.", link:"https://cur-convertor.vercel.app", tags:["React","Utility"], type:"Tool", year:"2025", color:"#34d399", repo:"React-repo" },
  { id:"r-11", name:"Password Generator", about:"Password generator tool with strength feedback, clipboard copy, and customizable character sets.", link:"https://pass-genrater.vercel.app", tags:["React","Security"], type:"Tool", year:"2025", color:"#f472b6", repo:"React-repo" },
  ...
  { id:"r-14", name:"Background Changer", about:"Background changer app with instant style swaps and visual customization built in React.", link:"https://my-bg-changer-omega.vercel.app", tags:["React","UI"], type:"Web App", year:"2025", color:"#f9a8d4", repo:"React-repo" },
